		<div>
			<img src="images/InnStrategy-logo.gif" alt="" />
								...
								<table cellspacing="0" cellpadding="1" border="0" id="Login1" style="border-width:0px;border-collapse:collapse;">
									<tr>
										<td><table cellpadding="0" border="0" style="font-family:Verdana;font-size:10pt;height:153px;">
											<tr>
												<td align="right"><label for="username">User Name:</label></td><td><input type="text" name="username" id="username" value="<?php echo set_value('username'); ?>" size="50" class="form" /><?php echo form_error('username'); ?></td>
											</tr><tr>
												<td align="right"><label for="password">Password:</label></td><td><input type="password" name="password" id="password" value="<?php echo set_value('password'); ?>" size="43" class="form" /><?php echo form_error('password'); ?></td>
											</tr><tr>
	...
	<script type="text/javascript">try{document.getElementById('username').focus();}catch(e){}</script>
